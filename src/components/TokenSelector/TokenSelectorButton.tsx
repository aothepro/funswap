  ...
  return (
    <button
      ...
      className={`hover:scale-130 text-black dark:text-white ${
        ...
        "scale-120 text-white hover:from-indigo-400 hover:to-teal-500 bg-linear-to-r/srgb from-indigo-500 to-teal-400"
      } ${
        isTokenSame(to, token) &&
        "scale-120 text-white hover:from-violet-400 hover:to-fuchsia-500 bg-linear-to-bl from-violet-500 to-fuchsia-500"
